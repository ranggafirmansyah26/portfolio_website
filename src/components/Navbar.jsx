export default function Navbar() {
	return (
		<div className="fixed top-0 left-0 right-0 flex justify-between h-24 items-center max-w-[1240px] mx-auto px-4 text-white">
			<h1 className="w-full text-3xl font-bold">Rangga</h1>
			<ul className="flex">
